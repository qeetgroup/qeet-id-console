// SSE reader for a qeetai turn. POSTs to the streaming endpoint and turns the
...
export async function* streamQeetAITurn(
  path: string,
  body: unknown,
  signal: AbortSignal,
  ...
  try {
    ...
    yield { type: "error", code: "network_error", message: "Could not reach Qeet AI." };
