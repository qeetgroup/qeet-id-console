...
import type { SearchContext, SearchItem, SearchSource } from "./types/registry.types";
...
const COMMANDS: CommandDef[] = [
  {
    ...
    icon: <Category className="size-4" />,
  ...
  },
  {
    ...
    icon: <RefreshArrow className="size-4" />,
  ...
  },
  {
    ...
    icon: <FingerScan className="size-4" />,
  ...
  },
  {
    ...
    icon: <DocumentDownload className="size-4" />,
    capability: "audit.read",
    run: ({ navigate }) => navigate("/security/audit-logs"),
  },
  {
  ...
  },
  {
    ...
    icon: <ColorSwatch className="size-4" />,
  ...
  },
  {
    ...
    icon: <SettingAlt className="size-4" />,
  ...
  },
  {
    ...
    icon: <Speedometer className="size-4" />,
