...
function ScimPage() {
  ...
  const scimLocked = useEntitlements().data?.features.scim === false;
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <FeatureGate
        feature="scim"
        title="SCIM directory sync is an Enterprise feature"
        description="Automatically provision and deprovision users from your identity provider (Okta, Entra ID…). Upgrade to Enterprise to enable SCIM."
      >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Users created or deprovisioned over SCIM. Deactivations (<code>active=false</code>)
              move a user to suspended and terminate their sessions.
            </CardDescription>
          </CardHeader>
